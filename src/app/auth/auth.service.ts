...
export class AuthService{
    ...
    return this.http
        .post<AuthReturnData>(
        "https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyBtBDYb9VWiPSxyB4_CVB5Da2ASNM8HV3c",
        {
            email: email,
            password: password,
    ...
    Login(email:string, password:string){
        return this.http
            .post<AuthReturnData>(
            "https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyBtBDYb9VWiPSxyB4_CVB5Da2ASNM8HV3c",
            {
                email: email,
                password: password,
                returnSecureToken: true
